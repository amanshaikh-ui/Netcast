...
export function loadSearchSettings(): SearchSettings {
  ...
  return {
    ...
    /** Default on — TikTok via Python subprocess (TikTokApi + Playwright). Set TIKTOK_DIRECT_PYTHON=false to disable. */
    tiktokDirectPython: !falsy(process.env.TIKTOK_DIRECT_PYTHON),
